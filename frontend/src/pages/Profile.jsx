  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 py-6 px-4 md:px-0">
      ...
      <motion.div 
        ...
        className="relative group bg-white/80 dark:bg-[#111621] rounded-[2.5rem] border border-slate-200 dark:border-white/5 shadow-2xl shadow-primary/5 overflow-hidden"
      >
        ...
        <div className="relative px-5 sm:px-8 pb-6 sm:pb-10 -mt-16 sm:mt-[-20px] flex flex-col md:flex-row items-center md:items-end gap-6 sm:gap-10 pt-20 sm:pt-24">
          ...
          <div className="flex-1 space-y-3 sm:space-y-4 mb-4 text-center md:text-left">
            <div className="flex flex-col sm:flex-row flex-wrap items-center gap-3 sm:gap-4">
              <h1 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white uppercase tracking-tighter drop-shadow-xl">{profileData?.name}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <motion.div 
            ...
            className="bg-white dark:bg-[#0B0F1A] rounded-[2.5rem] border border-slate-200 dark:border-white/5 shadow-xl p-10 space-y-8"
          >
            ...
            <div className="space-y-6">
               {[
                 ...
                 { icon: Clock, label: 'Hub Uptime Node', value: user?.session_start ? new Date(user.session_start).toLocaleString([], { dateStyle: 'short', timeStyle: 'short' }) : 'Initialized...', color: 'text-slate-500' }
               ].map((item, i) => (
                 <div key={i} className="group cursor-default">
                    <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 mb-2 ml-1">{item.label}</p>
                    <div className="flex items-center gap-4 bg-slate-50/50 dark:bg-white/5 p-4 rounded-2xl group-hover:bg-primary/5 transition-all duration-300">
                       ...
                       <span className="text-xs font-bold text-slate-900 dark:text-white truncate">{item.value}</span>
                    </div>
                 </div>
               ))}
            </div>
            ...
            <div className="pt-6 border-t border-slate-200 dark:border-white/5">
              <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 mb-3 ml-1">Clinical Bio-Archive</p>
             ...
             <div className="relative z-10 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <div className="flex flex-wrap justify-center sm:justify-start gap-4 sm:gap-6 text-slate-600 dark:text-slate-500">
             ...
             {isEditing ? (
               ...
               >
                  ...
                  <div className="flex items-center gap-4 border-b border-slate-200 dark:border-white/5 pb-6">
                     ...
                     <div>
                        <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Modify Registry Data</h3>
                        <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Authorized Clinical Identity Update</p>
                     </div>
                  </div>

                  <form onSubmit={handleUpdate} className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-2">
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] ml-1">Identity Display Name</label>
                       <div className="relative">
                          <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500" size={16} />
                          <input 
                              className="w-full h-14 bg-slate-50 dark:bg-white/5 border-0 rounded-2xl pl-12 pr-4 text-xs font-bold text-slate-900 dark:text-white focus:ring-4 focus:ring-primary/10 transition-all"
                              value={editForm.name}
                    ...
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] ml-1">Secure Email Terminal</label>
                       <div className="relative">
                    ...
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] ml-1">Rescue Mobile Terminal</label>
                       <div className="relative">
                    ...
                    <div className="md:col-span-2 space-y-2">
                       <label className="text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] ml-1">Clinical Specialization</label>
                       <div className="relative">
                          <Stethoscope className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500" size={16} />
                          <input 
                              className="w-full h-14 bg-slate-50 dark:bg-white/5 border-0 rounded-2xl pl-12 pr-4 text-xs font-bold text-slate-900 dark:text-white focus:ring-4 focus:ring-primary/10 transition-all"
                    ...
                    <div className="md:col-span-2 space-y-2">
                       <label className="text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] ml-1">Degrees & Certifications</label>
                       <div className="relative">
                    ...
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] ml-1">Years of Experience</label>
                       <div className="relative">
                    ...
                    <div className="md:col-span-2 space-y-2">
                       <label className="text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] ml-1">Clinical Terminal Avatar (Upload)</label>
                       <div className="relative group/upload">
                          <label className="flex items-center gap-4 w-full h-14 bg-slate-50 dark:bg-white/5 border-2 border-dashed border-slate-200 dark:border-white/10 rounded-2xl px-6 cursor-pointer hover:bg-primary/5 hover:border-primary/30 transition-all">
                             <Camera className="text-slate-500 group-hover/upload:text-primary transition-colors" size={18} />
               ...
               <motion.div 
                 ...
                 initial={{ opacity: 0, x: 30 }}
                 animate={{ opacity: 1, x: 0 }}
                 className="bg-white dark:bg-[#0B0F1A] rounded-[2.5rem] border border-slate-200 dark:border-white/5 shadow-2xl h-fit overflow-hidden"
               >
                  <div className="px-10 py-8 border-b border-slate-200 dark:border-white/5 flex justify-between items-center bg-slate-50/30 dark:bg-white/2">
                     <div>
                        <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight flex items-center gap-3">
                           <Activity className="text-primary" size={28} /> Diagnostic Archive
                        </h2>
                        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-1">Verified Historical Diagnostic Nodes</p>
                     </div>
                  </div>
                     ...
                     <div className="space-y-4">
                       {records.map((r, idx) => (
                         <motion.div 
                           ...
                           whileHover={{ x: 5 }}
                           className="p-6 bg-white dark:bg-[#0F1626] border border-slate-200 dark:border-white/5 rounded-3xl hover:border-primary/30 transition-all group flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-sm hover:shadow-xl"
                         >
                           <div className="flex items-center gap-6">
                             ...
                             <div>
                                <div className="flex items-center gap-2">
                                   <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tight">{r.disease} Prediction</h3>
                                   <span className="text-[8px] font-black uppercase px-2 py-0.5 bg-slate-100 dark:bg-white/10 rounded-full text-slate-600">ID: {r._id.slice(-4)}</span>
                                </div>
                                <p className="text-[10px] font-bold text-slate-500 flex items-center gap-2 uppercase tracking-widest mt-1.5">
                           ...
                           <div className="flex items-center justify-between md:justify-end gap-10">
                             <div className="text-left md:text-right">
                                ...
                                <p className="text-[12px] font-bold text-slate-900 dark:text-white max-w-[200px] truncate">
                                   {r.prediction_text}
                                 </p>
                             </div>
                           </div>
                       ...
                       {records.length === 0 && (
                         <div className="py-24 text-center space-y-4">
                           ...
                           <div>
                              <p className="text-[10px] font-black uppercase text-slate-500 tracking-[0.3em]">Neural Archive Offline</p>
      ...
      <motion.div 
        ...
        className="flex flex-wrap items-center justify-center gap-10 py-6 border-t border-slate-200 dark:border-white/5 opacity-50 grayscale hover:grayscale-0 transition-all duration-700"
      >
         <div className="flex items-center gap-3 text-slate-500 grayscale">
            <Shield size={20} />
