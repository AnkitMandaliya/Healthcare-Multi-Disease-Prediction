    ...
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-[#111621]/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-800/50 px-8 py-4 flex items-center justify-between transition-all duration-500">
      ...
      <div className="flex items-center gap-4 ml-6">
        ...
        <div className="relative group/notif">
          <button className="p-3 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-2xl relative transition-all shadow-sm hover:shadow-md overflow-hidden group">
          ...
          <div className="absolute right-0 mt-3 w-96 bg-white dark:bg-[#111621] border border-slate-200 dark:border-slate-800 rounded-[2rem] shadow-2xl overflow-hidden opacity-0 invisible translate-y-2 group-hover/notif:opacity-100 group-hover/notif:visible group-hover/notif:translate-y-0 transition-all duration-300 z-50">
